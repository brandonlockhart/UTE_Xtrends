 ...
 * @author uqiibra2
 */
public class XTR_BaiscView {
    
    public enum XTR_BasicMetric {PU_l2_norm,PU_Corr_distnace ,PI_Influence};
    ...
    public XTR_BasicMetric CurrMetic=XTR_BasicMetric.PU_l2_norm;
    ...
    public ArrayList<XTR_BasicPredicate> ViewPredicates= new ArrayList<XTR_BasicPredicate>();
...
//        jLabel8.setText("Where :"+Whr);
       ...
       System.out.println("========= Algorithm XTR_Basic ........... ============");
       System.out.println("======================================================");
    ...
    public void GetTargetAggMean(){
     ...
     public DefaultTableModel GetFastPredAggData(String Predicate){
        ...
        //System.out.println("PredicateAggValue \t TargetAggValue");
         for(XTR_BasicPredicate P : this.ViewPredicates){
     ...
     public XTR_BasicPredicate GetFastPred(String Predicate){
        
       // DefaultTableModel PredAggData=new DefaultTableModel();
        //System.out.println("PredicateAggValue \t TargetAggValue");
         XTR_BasicPredicate X=new XTR_BasicPredicate();
         for(XTR_BasicPredicate P : this.ViewPredicates){
             String Pwhre=P.PredicateWehe;
             if (Pwhre.equalsIgnoreCase(Predicate))
                 return P;
