 ...
 * @author uqiibra2
 */
public class XTR_BasicPredicate {
    String PredName="";
...
//                                        PredStatInf.add(this.InternalSim);
    ...
    public XTR_BasicPredicate FindPredicate(String PredName){
    
        XTR_BasicPredicate Predicate=new XTR_BasicPredicate();
        for(XTR_BasicPredicate NaivePredicate : View.ViewPredicates){
    ...
    // For Predicates Validation
     ...
     public String Get_PredAtts(String Attr_name, XTR_BasicPredicate P1) {
        //flag C store in Categoral data 
        //     R store in Numeric data 
        String AttCondition="";
//        if(PredAtts.getRowCount()<=0){
...
//        PredAtts.addColumn("AttType");
     ...
     public String NAIIVE_MergeP1_P2_Att(String MergedAtt,XTR_BasicPredicate Predicate1,XTR_BasicPredicate Predicate2){
         String P1_Att="";
         String P2_Att="";
         String P1_Op="";
     ...
     public String XTR_Basic_MergeP1_P2_Att (String MergedAtt,XTR_BasicPredicate Predicate1,XTR_BasicPredicate Predicate2){
         String P1_Att="";
         String P2_Att="";
         String P1_Op="";
         String P1_Predvalues=""; 
...
//                        }
     ...
     public String ModifyMergedPedicates(XTR_BasicPredicate P1 ,XTR_BasicPredicate P2 ){
