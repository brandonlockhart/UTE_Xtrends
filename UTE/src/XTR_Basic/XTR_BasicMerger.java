 ...
 * @author uqiibra2
 */
public class XTR_BasicMerger {
    
    public Metadata Md;
    public XTR_BaiscView CurView;
   ...
   public void Start_Basic() {
        ...
        int i=1;
                while(this.MergedSimilirty<=CurView.NearestTargetSim && i<CurView.AllSortedPredicates.getRowCount()){
                    ...
                    XTR_BasicPredicate TOPPredicate= FindFastPredicate(CurView.TopPredicate);
                    XTR_BasicPredicate Predicate= FindFastPredicate(PredicateWHER);
...
//                        System.out.println("ALready Merged Before !!!!!!!");
   ...
   public void BestMergedCAtt_S1(XTR_BasicPredicate ModifiedPredicate){
...
//                                  String PredValues= getBestAttrMergCluase(attr,P1_results);
                        ...
                        if(NoofRec>0 ){
                                        ...
                                        // Evaulate Predicate
                                         if (this.CurView.CurrMetic==XTR_BaiscView.XTR_BasicMetric.PU_l2_norm){
                                             MergedPredicate.ComputeTragetSimilirity();
                                         ...
                                         else if (this.CurView.CurrMetic==XTR_BaiscView.XTR_BasicMetric.PU_Corr_distnace){
                                             MergedPredicate.ComputeTragetCorr();
                                             //P.ComputeTragetPCorrDis();
                                             if(this.CurView.Print)
                                             System.out.println(MergedPredicate.PredName+"\t"+MergedPredicate.PredicateWehe+"\t"+MergedPredicate.NoRecods+"\t"+"\t"+MergedPredicate.TargetSim);
                                         }
                                         else if (this.CurView.CurrMetic==XTR_BaiscView.XTR_BasicMetric.PI_Influence){
   ...
   public void BestMergedRAtt(XTR_BasicPredicate ModifiedPredicate){
...
//          Predicate2=ReversePredicate( Predicate2);
   ...
   public boolean IsMergedBefore(String Predicate){
    ...
    public XTR_BasicPredicate FindFastPredicate(String PredName){
    
        XTR_BasicPredicate Predicate=new XTR_BasicPredicate();
        for(XTR_BasicPredicate NaivePredicate : CurView.ViewPredicates){
