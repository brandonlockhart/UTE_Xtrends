...
//                                        PredStatInf.add(this.InternalSim);
    ...
    public InNaivePredicate FindPredicate(String PredName){
    
        InNaivePredicate Predicate=new InNaivePredicate();
        for(InNaivePredicate NaivePredicate : View.ViewPredicates){
    ...
    // For Predicates Validation
     ...
     public String Get_PredAtts(String Attr_name, InNaivePredicate P1) {
        //flag C store in Categoral data 
        //     R store in Numeric data 
        String AttCondition="";
//        if(PredAtts.getRowCount()<=0){
...
//        PredAtts.addColumn("AttType");
     ...
     public String NAIIVE_MergeP1_P2_Att(String MergedAtt,InNaivePredicate Predicate1,InNaivePredicate Predicate2){
         String P1_Att="";
         String P2_Att="";
         String P1_Op="";
         ...
         String P2_PredAttType=""; 
            ...
            for (int i=0;i<Predicate1.PredAtts.getRowCount();i++){
                    ...
                    if((P1_PredAttType.equals(P2_PredAttType) && P1_PredAttType.equals("C")))  // ||
                           // (P1_Att.contains("id")||P1_Att.contains("ids"))) //Merge Categorical Attr
                    {
     ...
     public String ModifyMergedPedicates(InNaivePredicate P1 ,InNaivePredicate P2 ){
        
       // String ExeculdedAttr=Predicate1+" " +Predicate2+this.CurView.AggAtt+" " +this.CurView.WhrCond;
        String ExeculdedAttr=this.View.AggAtt+" " +this.View.WhrCond;
        String ModifiedPred=" ";
...
//            Predicate2=ReversePredicate( Predicate2);
			...
			String attr = columnAttribute1.getKey().toString().replaceAll(" ", "");
                        if (!ExeculdedAttr.contains(attr)) {
                         ...
                         //if (P1.PredicateWehe.contains(attr)&& P2.PredicateWehe.contains(attr))
                        if (P1.IS_Exist(attr)&& P2.IS_Exist(attr))    
                             ModifiedPred=ModifiedPred+NAIIVE_MergeP1_P2_Att( attr, P1, P2);
                         
                         //else if (P1.PredicateWehe.contains(attr)){
                         ...
                         //else if (P2.PredicateWehe.contains(attr)){
